...
public final class ProjectCatalog {
    ...
    private static List<TeamMemberIntro> teamFor(String channel,
        ...
        return List.of(
                ...
                member("elena", "Елена М.", "Frontend Developer", "🎨",
                        "React и UI kit. Связующее звено между backend и дизайном.",
                        "Привет! Если контракт API меняется — дай знать заранее."),
                member("nikita", "Никита Р.", "Junior Java Developer", "🌱",
                        "Недавно в команде — помогает с рутиной и учится на review.",
                        "Привет! Рад быть в команде — не стесняйся спрашивать.")
        );
    }
    ...
    private static List<TeamMemberIntro> teamEcommerce() {
        return List.of(
                member("anna", "Анна С.", "Team Lead", "👩‍💼",
                        ...
                        "Добро пожаловать в Checkout! Если что — пиши."),
                ...
                member("elena", "Елена М.", "Frontend Developer", "🎨",
                        "Checkout UI и A/B-тесты кнопок «Оплатить».",
                        "Привет! Если API checkout меняется — скажи до релиза."),
                member("nikita", "Никита Р.", "Junior Java Developer", "🌱",
                        "Пишет интеграционные тесты и мелкие фиксы.",
                        "Привет! Учусь на ваших PR — рад помочь с рутиной.")
        );
    }
    ...
    private static List<TeamMemberIntro> teamFintech() {
        return List.of(
                ...
                member("elena", "Елена М.", "Frontend Developer", "🎨",
                        "PCI-aware UI. Формы оплаты и 3DS flow.",
                        "Привет! В FinTech UI — каждый символ на счету."),
                member("nikita", "Никита Р.", "Junior Java Developer", "🌱",
                        "Пишет unit-тесты и помогает с мелкими тикетами.",
                        "Привет! Стараюсь не трогать prod без review.")
        );
    }
    ...
    private static List<TeamMemberIntro> teamStartup() {
        return List.of(
                ...
                member("elena", "Елена М.", "Frontend / Fullstack", "🎨",
                        "Делает UI быстрее, чем backend успевает API.",
                        "Hey! Ship UI first — mock the rest."),
                member("nikita", "Никита Р.", "Junior Developer", "🌱",
                        "Закрывает мелкие тикеты и учится на hotfix.",
                        "Привет! В стартапе учусь быстро — помогу где смогу.")
        );
    }
    ...
    private static List<TeamMemberIntro> teamEnterprise() {
        return List.of(
                ...
                member("elena", "Елена М.", "Frontend Developer", "🎨",
                        "Корпоративный UI kit и accessibility.",
                        "Welcome! Change request для UI — через JIRA."),
                member("nikita", "Никита Р.", "Junior Java Developer", "🌱",
                        "Работает по runbook. Эскалирует к senior.",
                        "Привет! В enterprise всё по процессу — учусь.")
        );
    }
    ...
    private static List<TeamMemberIntro> teamEdtech() {
        return List.of(
                ...
                member("elena", "Елена М.", "Frontend Developer", "🎨",
                        "Студенческий кабинет и прогресс-бары курсов.",
                        "Привет! UI для студентов — тестируем на staging."),
                member("nikita", "Никита Р.", "Junior Java Developer", "🌱",
                        "Фиксит баги в progress API по выходным.",
                        "Привет! EdTech — учусь у всей команды.")
        );
    }
